...
class Auth extends Config{
	...
	function enviar_contacto(){
		...
		$basemailfor2="info@scapetravelmarketing.com";
		...
		Teléfonos: +58 295 2637533 / 2645422 / 2647886 / 2631544 <br />
		Facebook: <a href='https://www.facebook.com/Scape-Travel-Marketing-CA-337376754709/?fref=ts'>Scape Travel</a><br />
		Twitter: <a href='https://twitter.com/scapetravel'>@scapetravel</a><br />
		Instagram: <a href='https://www.instagram.com/scapetravelmarketing/'>scapetravelmarketing</a>";
	...
	function enviar_cotizacion(){
		...
		$subject2= "Solicitud de Reserva desde Web ".$this->empresa;
		$basemailfor=$this->correo;
		$basemailfrom = "info@scapetravelmarketing.com";
...
function convertir_fecha($CampoFecha){
 ...
 function guardar_reserva2(){//productos
	...
	function enviar_solicitud_hotel(){
		...
		Scape Travel C.A<br /><br />

		Atentamente,<br />
		Departamento de Ventas ".$this->empresa."<br />
		Tel&eacute;fonos: +58 295 2637533 / 2645422 / 2647886 / 2631544<br />
		Facebook: <a href='https://www.facebook.com/Scape-Travel-Marketing-CA-337376754709/?fref=ts'>Scape Travel</a><br />
		Twitter: <a href='https://twitter.com/scapetravel'>@scapetravel</a><br />
		Instagram: <a href='https://www.instagram.com/scapetravelmarketing/'>scapetravelmarketing</a>";
...
/*var_dump($this->excursion,$this->tipo,$this->cedula,$this->nombre,$this->telefono,$this->email,$this->fecha_ida,$this->adultos,$this->ninos,$this->edades,$this->comentario);
	...
	function enviar_solicitud_paquete(){
		...
		$basemailfrom=$this->email;
		//$basemailfor="info@scapetravelmarketing.com";
		$basemailfor=$this->email_reserva;
		//$basemailfrom = $this->email;
...
/* 		echo("Aqui llego");
		...
		Atentamente,<br />
		Departamento de Ventas ".$this->empresa."<br />
		Teléfonos:+58 295 2637533 / 2645422 / 2647886 / 26315440<br />
		Facebook: <a href='https://www.facebook.com/Scape-Travel-Marketing-CA-337376754709/?fref=ts'>Scape Travel</a><br />
		Twitter: <a href='https://twitter.com/scapetravel'>@scapetravel</a><br />
		Instagram: <a href='https://www.instagram.com/scapetravelmarketing/'>scapetravelmarketing</a>";
		$this->mensaje="Su mensaje ha sido enviado satisfactoriamente!";
