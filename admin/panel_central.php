...
if(isset($_GET['msg']) && $_GET['msg']==1){
	$mensaje="<tr><td align='center' colspan='5' class='titulo'>Bienvenido a su Sistema de Administraci&oacute;n de Datos de Scape Travel, Agencia de Viajes. versi&oacuten 3.0.4</td></tr>";	
