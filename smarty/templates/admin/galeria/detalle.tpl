...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="normal">
  ...
  <tr>
    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="625" class="adminContenido">{$nombres|escape:'htmlall'}</td>
      </tr>
      <tr>
        <td align="left" class="subtituloWeb3">Fecha:</td>
        <td class="adminContenido">{$fecha|escape:'htmlall'}</td>
      </tr>
      <tr>
      ...
      <tr> {section name=i loop=$listado}
        <td width="10%" align="center" class="normalContenido2" valign="top"><a href="../galeria/publica_imagen2.php?id={$listado[i].id_image}" title="{$listado[i].nombre_image}" rel="lightbox[roadtrip]" ><img width="100" border="0" src="/imagenes/miniaturas/{$listado[i].directorio_image}" class="fotos" /></a><br />
          {$listado[i].nombre_image} <a onclick="javascript: return confirmar('&iquest;Esta seguro que desea borrar la imagen?');" href="imagen_borrar.php?id={$listado[i].id_image}&amp;back={$id}&amp;tabla=galeria"><img border="0" src="/imagenes/eliminar.png" width="15" height="15" align="absmiddle" /></a></td>
  ...
  <td width="25%" align="center"><a href="/admin/panel_central.php">Panel <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a></td>
    <td width="50%" align="center"><!-- InstanceBeginEditable name="insetar" --><a href="/admin/galeria">&nbsp;Volver <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a><!-- InstanceEndEditable --></td>
