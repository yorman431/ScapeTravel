...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="marco">
  ...
  <tr>
    <td colspan="3"><!-- InstanceBeginEditable name="contenido" -->
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="normal">
        <tr>
          <th colspan="4" align="left" class="titulo"><img src="/imagenes/cuadros.png" width="14" height="14" align="texttop" /> Im&aacute;genes de Banners Principal</th>
        ...
        <tr>
          ...
          <td width="180" class="subtituloWeb3">Enlace</td>
          <td width="180" class="subtituloWeb3">Subenlace</td>
          <td width="180" class="subtituloWeb3">Etiqueta</td>
          <td width="100" class="subtituloWeb3">Vinculo</td>
          <td width="80" class="subtituloWeb3">Orden</td>
  ...
  <tr {if $cont eq '0'} class='listado_a'
    ...
    <img src="/imagenes/banner/{$listado[i].url_ban}" width="200" border="0" class="fotos opacidad" /></a></td>
        <td class="adminContenido">{$listado[i].categoria_ban}</td>
      <td class="adminContenido">{$listado[i].subcategoria_ban}</td>
    ...
    <td width="40" align="center"><a onclick="javascript: return confirmar('&iquest;Seguro desea eliminar este registro?')" href="eliminar.php?id={$listado[i].id_ban}" title="Eliminar"><img src="/imagenes/delete.png" width="25" height="25" border="0" /></a></td>
      ...
      {if $mensaje eq ""}
      {$paginate.first}-{$paginate.last} de {$paginate.total} Imágenes.
  ...
  <td width="25%" align="center"><a href="/admin/panel_central.php">Panel <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a></td>
    <td width="50%" align="center"><!-- InstanceBeginEditable name="insetar" -->&nbsp;<a href="insertar.php">Insertar Banner <img src="/imagenes/nuevo.png" width="25" height="25" border="0" align="absmiddle" /></a><!-- InstanceEndEditable --></td>
