...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="normal">
  ...
  <tr>
    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="101" align="left" class="subtituloWeb3">Categoria:</td>
        <td width="625" class="adminContenido">{$categoria}</td>
      </tr>
      <tr>
        <td align="left" class="subtituloWeb3">Subcategor&iacute;a</td>
        <td class="adminContenido">{$subcategoria}</td>
      </tr>
      <tr>
    ...
    <img src="/imagenes/banner/{$url}" width="250" height="106" border="0" class="fotos opacidad" /></a><br />
          {$etiqueta}</td>
        </tr>
    </table>
        </td>
  ...
  <td width="25%" align="center"><a href="/admin/panel_central.php">Panel <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a></td>
    <td width="50%" align="center"><!-- InstanceBeginEditable name="insetar" --><a href="/admin/banner">&nbsp;Volver <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a><!-- InstanceEndEditable --></td>
