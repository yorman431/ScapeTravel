...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="MM_validateForm('nombre','','R');return document.MM_returnValue">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="normal">
    ...
    <tr>
      ...
      <td class="normalContenido"><input name="url" type="text" class="normalContenido" id="url" value="{$url}" size="48" maxlength="100" />
        <br />
        Ejemplo: http://www.creartejoyas.com</td>
    </tr>
    <tr>
    ...
    {$mensaje}
    <tr>
      <td colspan="2" align="center" class="normalContenido"><input name="envio" type="submit" class="componentes" id="button" onclick="javascript: return confirmar('¿Está seguro que desea guardar?');" value="Enviar" />
        &nbsp;&nbsp;
