...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="marco">
  ...
  <tr>
    <td colspan="3"><!-- InstanceBeginEditable name="contenido" -->
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="normal">
        <tr>
          <th colspan="3" align="left"><img src="/imagenes/cuadros.png" alt="" width="14" height="14" align="texttop" /> Lista de Subenlaces</th>
        ...
        <tr>
          ...
          <td width="274" class="subtituloWeb3">Etiqueta</td>
          <td width="100" class="subtituloWeb3">Prioridad</td>
          <td width="100" class="subtituloWeb3">Id</td>
  ...
  <tr {if $cont eq '0'} class='listado_a'
        ...
        <td class="adminContenido">{$listado[i].nombre_sub}</td>
      <td class="adminContenido">{$listado[i].etiqueta_sub}</td>
    <td class="adminContenido">{$listado[i].prioridad_sub}</td>
    <td class="adminContenido">{$listado[i].id_sub}</td>
    <td width="30" align="center"><a title="Detalles" href="sublink_detalle.php?id={$listado[i].id_sub}"><img src="/imagenes/detalle.png" width="30" height="25" border="0" /></a></td>
    <td width="30" align="center"><a title="Editar" href="sublink_editar.php?id={$listado[i].id_sub}"><img src="/imagenes/editar.png" width="25" height="25" border="0" /></a></td>
    <td width="30" align="center"><a title="Eliminar" onclick="javascript: return confirmar('&iquest;Seguro desea eliminar este registro?')" href="sublink_eliminar.php?id={$listado[i].id_sub}"><img src="/imagenes/delete.png" width="25" height="25" border="0" /></a></td>
  </tr>
        {/section}
        {else}
        {$mensaje}
        ...
        <tr>
          <td class="paginacion" align="right" colspan="10">
            ...
            {if $mensaje eq ""}
            {$paginate.first}-{$paginate.last} de {$paginate.total} Subenlaces.
  ...
  <td width="25%" align="center"><a href="/admin/panel_central.php">Panel <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a></td>
    <td width="50%" align="center"><!-- InstanceBeginEditable name="insetar" -->&nbsp;<a href="sublink_insertar.php">Insertar Subenlace <img src="/imagenes/nuevo.png" width="25" height="25" border="0" align="absmiddle" /></a>&nbsp;&nbsp;&nbsp;<a href="index.php">Lista Enlaces <img src="/imagenes/cambiar.png" width="25" height="25" border="0" align="absmiddle" /></a><!-- InstanceEndEditable --></td>
