...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="marco">
  ...
  <tr>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="normal">
        <tr>
          <th colspan="4" align="left" class="titulo"><img src="/imagenes/cuadros.png" width="14" height="14" align="texttop" /> Lista de Suscripci&oacute;n</th>
        ...
        <tr>
          <td width="180" class="subtituloWeb3">Correos Suscritos</td>
          <td width="180" class="subtituloWeb3">Fecha Suscripci&oacute;n</td>
        </tr>
        {if $mensaje neq "si"}
  ...
  <tr {if $cont eq '0'} class='listado_a'
    ...
    <td class="adminContenido">{$listado[i].correo_sus}</td>
    <td class="adminContenido">{$listado[i].fecha_sus}</td>
    <td width="40" align="center"><a onclick="javascript: return confirmar('&iquest;Seguro desea eliminar este registro?')" href="eliminar.php?id={$listado[i].id_sus}" title="Eliminar"><img src="/imagenes/delete.png" width="25" height="25" border="0" /></a></td>
  </tr>
        {/section}
        {else}
        {$mensaje}
