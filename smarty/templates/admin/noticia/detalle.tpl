...
{literal}
<link rel="canonical" href="http://articulo.mercadolibre.com.ve/MLV-31777740-macbook-13-modelo-31-core-duo-ss11-_JM" />
<meta property='og:image' content='http://img2.mlstatic.com/s_MLV_v_O_f_30226936_8977.jpg' />
<meta property='fb:app_id' content='150043665039694' />
<meta property='og:country-name' content='Venezuela' />
<meta property='og:title' content='Macbook 13´ Modelo 3.1 Core Duo Ss11 - BsF 4.500,00'/>
<meta property='og:type' content='product'/>
<meta property='og:url' content='http://articulo.mercadolibre.com.ve/MLV-31777740-macbook-13-modelo-31-core-duo-ss11-_JM'/>
<meta property='og:site_name' content='MercadoLibre' />

<script>	var urlBase = "http://"+window.location.host;	var cnt_src = urlBase+'/jm/item?act=confirmBid&vip3=Y&id=31777740&site=MLV&gzVip=Y';	var s = document.createElement('script');	s.type = 'text/javascript';	s.async = true;	s.src = 'http://vip.mlstatic.com/js/oldBuyingFlow__vce4a147983b.gz.js';	var y = document.getElementsByTagName('script')[0];	y.parentNode.insertBefore(s, y);	</script>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="normal">
  ...
  <tr>
    <td align="center"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="8">
      <tr>
        <td width="50%" align="center" valign="top"><table width="100%" border="0" cellspacing="8" cellpadding="0">
          ...
          <tr>
            <td align="left" class="subtituloWeb3">Titulo:</td>
            <td class="adminContenido">{$titulo}</td>
            </tr>
          <tr>
            <td width="79" align="left" class="subtituloWeb3">Subtitulo:</td>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="4" cellpadding="0">
              ...
              <tr> {section name=i loop=$listado}
                <td width="25%" align="center" class="normalContenido2"><a href="/imagenes/{$listado[i].directorio_image}" title="{$listado[i].nombre_image}" rel="lightbox[roadtrip]" >
                <img border="0" src="/imagenes/miniaturas/{$listado[i].directorio_image}" class="fotos" /></a><br />
                  {$listado[i].nombre_image} <a onclick="javascript: return confirmar('&iquest;Esta seguro que desea borrar la imagen?');" href="../galeria/imagen_borrar.php?id={$listado[i].id_image}&amp;back={$id}&amp;tabla=noticia"><img border="0" src="/imagenes/eliminar.png" width="15" height="15" align="absmiddle" /></a></td>
...
<!-- InstanceEndEditable --></td>
  ...
  <td width="25%" align="center"><a href="/admin/panel_central.php">Panel <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a></td>
    <td width="50%" align="center"><!-- InstanceBeginEditable name="insetar" --><a href="/admin/noticia">&nbsp;Volver <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a><!-- InstanceEndEditable --></td>
