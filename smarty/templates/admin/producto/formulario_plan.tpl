            ...
            <td align="right" class="tituloWeb"><table width="60%" border="0" align="center" cellpadding="0" cellspacing="0">
              {$mensaje}
                ...
                <tr>
                    ...
                    <td class="adminContenido"><input onkeypress="javascripts: return validarletrasnum(event);" name="descripcion_plan" type="text" id="descripcion_plan" value="{$descripcion_plan}" size="71" maxlength="150" /> 
                      *</td>
                </tr>
                <tr>
                  <td align="left" class="subtituloWeb3">Precio Bs.</td>
                ...
                <tr>
                  <td align="left" class="subtituloWeb3">M&aacute;ximo de Aduldos:</td>
                  <td><span class="adminContenido">
                    <input name="maxadultos" type="text" id="maxadultos" value="{$maxadultos}" size="71" maxlength="10" onkeypress="javascripts: return validarnum(event);" />
                  *</span></td>
                </tr>
                <tr>
