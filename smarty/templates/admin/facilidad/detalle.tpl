    ...
    <td align="center" class="titulo"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="8">
      <tr>
        <td width="50%" align="center" valign="top"><table width="100%" border="0" cellspacing="8" cellpadding="0">
          <tr>
            <td width="79" align="left" class="subtituloWeb3">Nombre:</td>
            <td width="261" class="adminContenido">{$nombres}</td>
            </tr>
          <tr>
            <td align="left" class="subtituloWeb3">Etiqueta:</td>
            <td class="adminContenido">{$etiqueta}</td>
            </tr>
          </table></td>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="4" cellpadding="0">
              ...
              <tr> {section name=i loop=$listado}
                <td width="25%" align="center" class="normalContenido2"><a href="/imagenes/{$listado[i].directorio_image}" title="{$listado[i].nombre_image}" rel="lightbox[roadtrip]" ><img border="0" src="/imagenes/miniaturas/{$listado[i].directorio_image}" class="fotos" height="100" width="100" /></a><br />
                  {$listado[i].nombre_image|escape:"htmlall"} <a onclick="javascript: return confirmar('&iquest;Esta seguro que desea borrar la imagen?');" href="../galeria/imagen_borrar.php?id={$listado[i].id_image}&amp;back={$id}&amp;tabla=facilidad"><img border="0" src="/imagenes/eliminar.png" width="15" height="15" align="absmiddle" /></a></td>
...
<!-- InstanceEndEditable --></td>
  ...
  <td width="25%" align="center"><a href="/admin/panel_central.php">Panel <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a></td>
    <td width="50%" align="center"><!-- InstanceBeginEditable name="insetar" --><a href="/admin/facilidad">&nbsp;Volver <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a><!-- InstanceEndEditable --></td>
