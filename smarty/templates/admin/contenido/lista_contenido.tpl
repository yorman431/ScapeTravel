...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="marco">
    ...
    <td colspan="3"><!-- InstanceBeginEditable name="contenido" -->
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="normal">
        ...
        <tr>
          ...
          <td width="15%" class="subtituloWeb3">Subenlace</td>
          <td width="30%" class="subtituloWeb3">Nombre</td>
          <td width="10%" class="subtituloWeb3">Fecha</td>
          <td width="15%" colspan="3" align="center" class="subtituloWeb3">Acciones</td>
        </tr>
        {if $mensaje eq ""}
  ...
  <tr {if $cont eq '0'} class='listado_a'
    ...
    <td width="5%" align="center"><a title="Eliminar" onclick="javascript: return confirmar('&iquest;Seguro desea eliminar este registro?')" href="eliminar.php?id={$listado[i].id_con}"><img src="/imagenes/delete.png" width="25" height="25" border="0" /></a></td>
        ...
        {/if}
        <tr>
          <td class="paginacion" align="right" colspan="7">
  ...
  <td width="25%" align="center"><a href="/admin/panel_central.php">Panel <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a></td>
    <td width="50%" align="center"><!-- InstanceBeginEditable name="insetar" -->&nbsp;<a href="insertar.php">Insertar Contenido <img src="/imagenes/nuevo.png" width="25" height="25" border="0" align="absmiddle" /></a><!-- InstanceEndEditable --></td>
