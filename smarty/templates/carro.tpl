...
================================================== -->
  ...
  <nav class="navbar navbar-default navbar-fixed-top altura-1">
   ...
   <!--NavBar 2 
    ...
    <div class="row reducir">
    			<div class="panel panel-default"> 
                	<div class="panel-body">
                    {literal}
                    	<ol class="timeline">
                        
                            <li class="timeline__step {/literal}{if $numero gte 1}done{/if}{literal}">
                            ...
                            <li class="timeline__step {/literal}{if $numero gte 2}done{/if}{literal}">
                                ...
                                <span class="timeline__step-title">
                                    <i class="fa fa-lock"></i> Sign In</span>
                        
                                <i class="timeline__step-marker">2</i>
                            </li>
                            
                            <li class="timeline__step {/literal}{if $numero gte 3}done{/if}{literal}">
                                ...
                                <span class="timeline__step-title">
                                    <i class="fa fa-map-marker"></i> Shipping</span>
                                
                                <i class="timeline__step-marker">3</i>
                            </li>
                            
                            <li class="timeline__step {/literal}{if $numero gte 4}done{/if}{literal}">
                                ...
                                <span class="timeline__step-title">
                                    <i class="fa fa-check-square-o"></i> Place</span>
                                
                                <i class="timeline__step-marker">4</i>
                            </li>
                            
                            <li class="timeline__step {/literal}{if $numero gte 5}done{/if}{literal}">
            ...
            {if $paso eq "paso1"}
        		{include file="carro_compra1.tpl"}
            {/if}
            
            {if $paso eq "paso2"}
        		{include file="carro_compra2.tpl"}
            {/if}
            
            {if $paso eq "paso3"}
        		{include file="carro_compra3.tpl"}
            {/if}
            
            {if $paso eq "paso4"}
        		{include file="carro_compra4.tpl"}
            {/if}
            
            {if $paso eq "paso5"}
        		{include file="carro_compra5.tpl"}
            {/if}
