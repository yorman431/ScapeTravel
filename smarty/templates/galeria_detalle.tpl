            ...
            <div class="col-xs-12">
             ...
             <div class="col-xs-12">
                       ...
                       <div class="col-xs-6 col-md-3">
                        <a class="thumbnail" title="{$imagenes[i].nombre_image}" href="/imagenes/{$imagenes[i].directorio_image}" data-toggle="lightbox" data-title="{$imagenes[i].nombre_image}" data-gallery="multiimages" data-footer="">
                        <img  src="/imagenes/{$imagenes[i].directorio_image}" alt="{$imagenes[i].nombre_image}" class="img-responsive" width="700" />
                       </a>
                             </div>
                         {/section}
                          {literal}
                        ...
                        <div class="panel-footer" style="background-color:#0073c4;">
                        <a class="btn btn-primary btn-block" title="Volver a Galería" href="galeria.php" role="button" style="background-color:#0073c4; border-color:transparent;"><i class="fa fa-arrow-circle-o-left"></i>&nbsp;Volver a Galería</a>
                        </div>
                    </div>
