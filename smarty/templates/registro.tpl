        	...
        	<div class=" col-md-push-4 col-md-4 col-xs-12 no_padding">
            	<div class="panel panel-cotizacion">
                    ...
                    <div class="panel-body">
                      ...
                      <input name="cedula" type="text" id="cedula" value="{$cedula}" class="form-control" maxlength="9" onkeypress="javascript: return validarnum(event);" placeholder="Cédula o Pasaporte *" />
                              ...
                              <div class="form-group">
                                  ...
                                  <label class="sr-only" for="nombre">Nombres:</label>
                                    <input name="nombre" type="text" id="nombre" class="form-control" onkeypress="javascript: return validarletras(event);" value="{$nombre}" maxlength="100" placeholder="Nombre *" /> 
                            ...
                            <div class="form-group" style="border-left: 1px solid #ddd;">
                         		<label class="sr-only" for="apellido">Apellido</label>
                        			...
                        			<input onkeypress="javascript: return validarletras(event);" name="apellido" type="text" id="apellido" value="{$apellidos}" size="40" maxlength="50" class="form-control" placeholder="Apellido *"/>
                          ...
                          <label class="sr-only" for="genero">Genero</label>
                             ...
                             <select name="sexo" id="sexo" class="form-control">
                                  <option value="Masculino" {if $sexo eq "Masculino"} selected='selected' {/if}>Masculino</option>
                                  <option value="Femenino" {if $sexo eq "Femenino"} selected='selected' {/if}>Femenino</option>
                            </select>
                         ...
                         <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></span>
                        	<input onKeyPress="javascript: return validarcorreo(event);" name="correo" type="text" id="correo" value="{$correo}" size="40" maxlength="100" class="form-control" placeholder="Correo *" />
                            </div>
                        </div>
                      ...
                      <div class="form-group">
                          ...
                          <span class="input-group-addon"><span class="glyphicon glyphicon-earphone"></span></span>
                        	<input name="celular" type="text"  id="celular" value="{$celular}" size="40" maxlength="20" onKeyPress="javascripts: return validarnum(event);" class="form-control" placeholder="Celular *" /> 
                          </div>
                        </div>
                 ...
                 <div class="form-group" style="border-left: 1px solid #ddd;">
                    ...
                    <div class="form-group">
                      Acepto los <a class="Terminos" target="_blank" href="/contenido.php?cont=19">t&eacute;rminos y condiciones</a> establecidos por {$nombre_empresa}
                  	</div>
