              ...
              {if $total neq ""}
                  ...
                  <td colspan="2">
                   <div id="caja_cotizacion">
                      <div class="titulo4">Resultado de Cotizaci&oacute;n:<br />
<span class="titulo2">(Plan: {$listado[0].nombre} Descripci&oacute;n: {$listado[0].descripcion})</span></div>
                      <form id="formulario" name="formulario" method="post" action="carro.php">
                          <input type="hidden" name="id" id="id" value="{$producto}" />
                          ...
                          <input name="proceso" type="hidden" id="proceso" value="producto" />
                          <input type="hidden" name="tipo" id="tipo" value="{$listado[0].categoria_pro}" />
                      ...
                      <tr>
                        <td colspan="4" class="titulo8">Fechas de salida: {$llegada}</td>
                        </tr>
                        {assign var="temp2" value=1}
                        {section name=i loop=$personas}
                      <tr class="titulo9">
                        <td width="35%">Personas:</td>
                      ...
                      <tr class="titulo_alt2">
                        ...
                        <td bgcolor="#ffddc6">
                        Bs.{math equation="x * y" x=$personas[i][0] y=$personas[i][3]}
                        </td>
                      </tr>
                      <tr class="titulo_alt2">
                        <td>Infantes:</td>
                        ...
                        <td bgcolor="#ffddc6">
                         Bs.{math equation="x * y" x=$personas[i][1] y=$personas[i][4]}
                        </td>
                      </tr>
                      <tr class="titulo_alt2">
                        <td>Ni&ntilde;os:</td>
                        ...
                        <td bgcolor="#ffddc6">
                         Bs.{math equation="x * y" x=$personas[i][2] y=$personas[i][5]}
                        </td>
                      </tr>
                      <tr>
                        <td colspan="4" >
                      ...
                      <tr>
                        ...
                        <div class="boron_carro_base"><a onclick="javascripts: document.formulario.submit(); return false;" href="#" title="Agregar al Carrito de Compras"><div class="boton_carro"></div></a></div>
                        </td>
                        </tr>
                    </table>
                  </form>
                  ...
                  {/if}
            <tr>
              <td><form action="" method="post" name="form_cotizar" id="form_cotizar" onsubmit="MM_validateForm('llegada','','R');return document.MM_returnValue">
                <table width="100%" align="center" class="formularios">
                  ...
                  <tr bgcolor="#eee">
                    <td width="200" align="left" class="titulo_alt">N&ordm; Adultos:<br />
            ...
            <select name="numero_adultos{$cont2}" id="numero_adultos{$cont2}">
            	...
            	{section name=i loop=$listado[0].maxAdultos}
             	...
             	{/section}
                  ...
                  <tr>
                    <td align="left" class="titulo_alt">Fecha estimada:</td>
