                              ...
                              <div class="form-group">
                                   <div class="input-group">
                                            ...
                                            <label class="sr-only" for="origen">Origen:</label>
                                                <input  name="origen" type="text" id="origen" class="form-control"  value="{$origen}" maxlength="100" class="form-control" placeholder="Origen *" /> 
                                     </div>
                                </div>
                                ...
                                <div class="input-group">
                                            ...
                                            <label class="sr-only" for="destino">Destino:</label>
                                                <input  name="destino" type="text" id="destino" class="form-control"  value="{$destino}" maxlength="100" class="form-control" placeholder="Destino *" /> 
                                </div>
                          </div> 
                                <div class="form-group">
