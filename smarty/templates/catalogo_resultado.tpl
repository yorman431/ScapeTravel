	...
	<!-- InstanceBeginEditable name="contenido" -->
     <div class="row">
    	...
    	<div class="col-xs-12 col-sm-4"> 
            ...
            <h3 style="margin-top:10px">{$accion}</h3>
                     ...
                     <h5 align="right">
                        <div class="form-group form-group-sm">
                            ...
                            <select class="form-control" id="orden" name="orden" onchange="javascripts: document.form_ordenar.submit();">
                                <option {if $ordenar eq ""} selected='selected'{/if} value=""><-- Seleccione --></option>
                                <option {if $ordenar eq "vistas_hot DESC"} selected='selected'{/if} value="vistas_hot DESC">M&aacute;s elegidos</option>
                                <option {if $ordenar eq "categoria_hot DESC"} selected='selected'{/if} value="categoria_hot DESC">Estrellas: Mayor a menor </option>
                                <option {if $ordenar eq "categoria_hot ASC"} selected='selected'{/if} value="categoria_hot ASC">Estrellas: Menor a mayor </option>
                                <option {if $ordenar eq "categoria_hot DESC, nombre_hot"} selected='selected'{/if} value="categoria_hot DESC, nombre_hot">Precio: Mayor a menor</option>
                                <option {if $ordenar eq "categoria_hot ASC, nombre_hot"} selected='selected'{/if} value="categoria_hot ASC, nombre_hot">Precio: Menor a mayor</option>
                            </select>
                        </div>
                    </h5>
                </div>
    	...
    	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" style="margin-bottom:15px; {if $cont2 le 3} margin-top:15px; {/if}">
        ...
        {assign var="cont2" value=$cont2+1}          	
                <div class="panel panel-default panel-cotizacion">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no_padding no_padding2">
                    	...
                    	<ul class="list-group">
                              <li class="list-group-item text-center titulo"><h4 style="margin-bottom:0px; margin-top:0px;">Desde BsF. 800</h4></li>
                              <li class="list-group-item center-block"><img class="img-responsive" src="/imagenes/{$listado[i].categoria_hot}.png" alt="hotel con categoria {$listado[i].categoria_hot}"/></li>
                              <li class="list-group-item center-block">{if $listado[i].facilidades neq ""}
                            <div class="row">
                                {section name=j loop=$listado[i].facilidades}
                                <div class="col-xs-2 no_padding center-block">
                                    {if $listado[i].facilidades[j].directorio_image neq ""} 
                                    <img alt="El {$listado[i].nombre_hot} cuenta con {$listado[i].facilidades[j].nombre_fac} hoteles de Ecuador" title="{$listado[i].facilidades[j].nombre_fac}" border="0" src="/imagenes/miniaturas/{$listado[i].facilidades[j].directorio_image}" class="img-responsive opacidad"/>
                                    {/if}
                                </div>
                                {/section}
                            </div>
