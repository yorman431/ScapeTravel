  ...
  <nav class="navbar navbar-default navbar-fixed-top altura-1">
   ...
   <!--NavBar 2 
	...
	<!-- InstanceBeginEditable name="contenido" -->
       <div class="titulo_principal">Recuperar Informaci&oacute;n de Cuenta</div>
              <table class="normal" border="0" cellspacing="0" cellpadding="0" align="center">
                    {$mensaje2}
                      <tr>
                    <th colspan="2" align="center"><img src="/imagenes/cuadros.png" width="14" height="14" align="left" />Formulario de Recuperaci&oacute;n<img src="/imagenes/cuadritos.png" width="37" height="11" align="right" /></th>
                    </tr>
                      <tr>
                        <td class="normalContenido">
                          <form action="" method="post" name="form1" id="form2" onsubmit="MM_validateForm('cedula','','RisNum','correo','','RisEmail');return document.MM_returnValue">
                            <table width="60%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="23%" align="left" class="botonContenido"><strong>Cedula: </strong></td>
                                <td width="77%"><input name="cedula" type="text" class="normalContenido" id="cedula" onkeypress="javascript: return validarnum(event);" size="35" maxlength="8" />
                                  *</td>
                              </tr>
                              <tr>
                                <td class="botonContenido" align="left"><strong>E-mail:</strong></td>
                                <td><input onkeypress="javascript: return validarcorreo(event);" name="correo" type="text" class="normalContenido" id="correo" size="35" maxlength="60" />
                                  *</td>
                              </tr>
                              <tr>
                                <td class="texto_gen3">&nbsp;</td>
                                <td align="left"><input name="enviar" type="submit" class="normalContenido" id="enviar" value="Recuperar" />
                      ...
                      <tr>
                        <td class="normalContenido"><p>
                          <span class="subtituloWeb3">Nota:</span> Para recuperar  clave, su correo(**) y c&eacute;dula ser&aacute;n verificados. Si los datos coinciden, autom&aacute;ticamente le enviaremos un e-mail con los datos de su cuenta. Le recomendamos que guarde dicho e-mail para usos posteriores.</p>
                          <p>(**) El correo que debe insertar, es el que us&oacute; cuando realiz&oacute; su primer registro.
                          </p></td>
                        </tr>
              </table>
            <!-- InstanceEndEditable -->
