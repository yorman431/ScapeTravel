  ...
  <nav class="navbar navbar-default navbar-fixed-top altura-2">
    ...
    <div class="row contacto">
    	...
    	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        	<div class="panel panel-cotizacion">
                ...
                <div class="panel-body">
                     <form action="" method="post" role="form" name="formulario_reserva" id="formulario_reserva" onsubmit="MM_validateForm('email','','RisEmail');return document.MM_returnValue">
                      ...
                      <input  onkeypress="javascrip: return validarletrasnum(event);" type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre Completo" value="{$nombre}">
          ...
          <input  onkeypress="javascrip: return validarnum(event);" type="number" class="form-control" name="telefono" id="telefono" placeholder="Teléfono" value="{$telefono}"> 
                          	</div>
                        </div>
                    ...
                    <input  onkeypress="javascrip: return validarcorreo(event);" type="email" class="form-control" id="email" name="email" placeholder="correo@dominio.com" value="{$email}">
                            </div>
                        </div>
