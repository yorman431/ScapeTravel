...
================================================== -->
  ...
  <nav class="navbar navbar-default navbar-fixed-top altura-2">
	...
	{if $cont eq '6'}</div><div class="row" {if $cont ge '6'} id="visible" style="display:none;"{/if}>{/if}
     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 ajuste-margin" style="margin-bottom:15px; {if $cont2 le 4} margin-top:15px; {/if}">
          ...
          {assign var="cont2" value=$cont2+1}
            <div class="panel panel-default panel-cotizacion">
             	<div class="panel-header" style="background-color:#0073c4; color:#fff;">
                	 <h4 align="center" style="height:30px; padding-top:5px;"class="no_margin2">{$noticias[i].titulo_not|truncate:45}</h4>
                </div>
                <div class="panel-body no_padding no_padding2">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-7 no_padding no_padding2" align="center"> 
                     ...
                     <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5 no_padding no_padding2">
                    	<div class="panel panel-default panel-cotizacion">
                          <div class="panel-body no_padding no_padding2" align="center" style="padding-top:8%;">
                    	     <ul class="list-group">
                             	<li class="list-group-item text-center">
                                	{$noticias[i].subtitulo_not}
                                </li>
                                <li class="list-group-item text-center">
                                	<i class="fa fa-calendar-o"></i>&nbsp;{$noticias[i].fecha_not}
                                </li>
                                 <li class="list-group-item text-center">
                                 {$noticias[i].contenido_not|truncate:50}
                                 </li>
                             </ul>
                          </div>
                        </div>
                ...
                <div class="panel-footer">
                              		<a class="btn btn-default btn-block" title="{$listado[i].nombre_hot}"href="/noticia_detalle.php?id={$noticias[i].id_not}">Ver más  &nbsp; <i class="fa fa-arrow-circle-right"></i></a>
               </div>
             </div>
	</div>
    {/section}
 ...
 {if $noticias|@count gt 6}
      			<div class="container-fluid" style="margin-top:10px; margin-bottom:10px;">
      				<div class="row" id="mostre-todo">
        				<div class="col-xs-12" align="center">
            				<a href="#visible" class="btn btn-primary visible" onclick="mostrar()"><i class="fa fa-refresh fa-spin"></i>&nbsp;Cargas M&aacute;s</a>
                       </div>
                   </div>
               </div>
          {/if}
