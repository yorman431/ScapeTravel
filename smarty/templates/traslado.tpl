                ...
                {if $mensaje2 eq ""}
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        {section name=i loop=$traslado}
                          <tr>
                            <td>{$traslado[i].ruta}</td>
                            <td align="center">{if $traslado[i].costo == 0.00} <strong>Gratis</strong>{else}Bs. {$traslado[i].costo} {/if}</td>
                            <td align="center">{if $traslado[i].costo_nino == 0.00} <strong>Gratis</strong>{else}Bs. {$traslado[i].costo_nino} {/if}</td>
                          </tr>
                        {/section}
                      </tbody>
                      <tfoot>
                              ...
                              {$msj_traslado}
                                 ...
                                 <div class="form-group">
                                      <div class="input-group">
                                        ...
                                        <input name="nombre" type="text" id="nombre" class="form-control" onkeypress="javascript: return validarletras(event);" value="{$nombre}" maxlength="100" placeholder="Nombres*" />
                                      </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                      <div class="input-group">
                                        ...
                                        <input name="apellido" type="text" id="apellido" class="form-control" onkeypress="javascript: return validarletras(event);" value="{$nombre}" maxlength="100" placeholder="Apellidos *" />
                                      </div>
                                 </div>
                                          ...
                                          <input  name="destino" type="text" id="destino" class="form-control"  value="{$destino}" maxlength="50" class="form-control" placeholder="Destino *" />
                                               ...
                                               <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no_padding espaciado-10">
                                                ...
                                                <div class='input-group date' id='datetimepicker'>
                                                    ...
                                                    <input type='text' class="form-control" id="fecha" name="fecha" value="{$fecha}" placeholder="Fecha *" />
                                                    <span class="input-group-addon">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no_padding espaciado-10">
                                              <div class="form-group">
                                                <div class="input-group">
                                                  ...
                                                  <input class="form-control" name="nino" type="text" id="nino" onkeypress="javascript: return validarnum(event);" onblur="javascript: return numero_ninos();" value="{$menores}" maxlength="4" placeholder="Menores *" />
                                                </div>
                                              </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 no_padding">
                                              <div class="form-group">
                                                <div class="input-group">
                                                  ...
                                                  <textarea name="observciones" type="text" rows="4" id="observaciones" class="form-control"  value="{$observaciones}" maxlength="250" class="form-control" placeholder="Observaciones *"></textarea>
                                                </div>
                                              </div>
                                            </div>
