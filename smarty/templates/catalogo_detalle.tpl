  ...
  <nav class="navbar navbar-default navbar-fixed-top altura-2">
    ...
    <div class="container-fluid no_padding">
        ...
        <div class="col-xs-12" align="center">
              <h2 style="margin-bottom:30px; margin-top:30px;">{$accion}</h2>
        </div>
      </div>
...
<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="padding-bottom:15px;">
    ...
    <div id="galeria_catalogo" class="carousel slide" data-ride="carousel"> 
          ...
          {section name=i loop=$opciones_img}
            <li data-target="#galeria_catalogo" data-slide-to="{$cont}" {if $cont eq "0"}class="active"{/if}></li>
          ...
          {section name=i loop=$opciones_img}
            <div {if $cont eq "0"}class="item active"{else}class="item"{/if}>
              <img class="img-responsive" alt="{$opciones_img[i].nombre_image}" src="/imagenes/{$opciones_img[i].directorio_image}">    
            </div>
          {assign var="cont" value=$cont+1}
          {/section}
          </div>
    	...
    	<div class="panel panel-default panel-cotizacion" align="center" style="margin-bottom:100px;">
        	<div class="panel-body no_padding no_padding2">
                          ...
                          <div id="video" class="tab-pane fade">
                             <div class="panel panel-default paneltabs">
                              <div class="panel-body">
                                    ...
                                    {if $tipo_video eq 'Vimeo'}
                                        {section name=i loop=$videos}
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="//player.vimeo.com/video/{$videos[i]}"  frameborder = "0" webkitallowfullscreen mozallowfullscreen allowfullscreen> </iframe>
                                        </div><br />
                                        {/section}
                                    {/if}
                                   ...
                                   <!--Modelo de video Youtube-->
                                    {if $tipo_video eq 'Youtube'}
                                        {section name=i loop=$videos}
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/{$videos[i]}" frameborder="0" allowfullscreen></iframe>
                                        </div><br />
                                        {/section}
                                    {/if}
                             ...
                             <div class="panel panel-default paneltabs">
                              <div class="panel-body">
                                {section name=i loop=$opciones_img}
                                  ...
                                  <a class="thumbnail" title="{$opciones_img[i].nombre_dir}" href="/imagenes/{$opciones_img[i].directorio_image}" data-toggle="lightbox" data-title="{$opciones_img[i].nombre_image}" data-gallery="multiimages" data-footer="">
                                       <img  src="/imagenes/{$opciones_img[i].directorio_image}" alt="{$opciones_img[i].nombre_image}" class="img-responsive" width="700" />
                                  </a>
                ...
                <!---Termina El panel de promociones--->   
                    ...
                    <a class="btn btn-default btn-block visible" title="Reservar {$accion}" href="#visible" onclick="mostrar()"> <i class="fa fa-calendar-check-o"></i> &nbsp; Solicitar Reserva</a>
                     </div>
                   </div>
             </div>
			</div>
            <!--- Formulario Reserva -->
              <div class="row" style="{if $error eq 'no'} display:none;{/if} height:766px; background-image:url(/imagenes/formularios.jpg); background-repeat:no-repeat; padding-top:20px;"  id="visible">
              <div class="col-xs-12" align="center">
                        <h1 style="color:#fff;">Reserva {$accion}</h1>
                </div>
             <div class="col-md-push-3 col-md-6 col-xs-12">
             	<div class="panel panel-cotizacion">
                            	...
                            	<div class="row">
                                   ...
                                   <div class="input-group">
                                            ...
                                            <label class="sr-only" for="Pax"># Pax:</label>
                                                <input  name="adultos" type="text" id="adultos" onkeypress="javascript: return validarnum(event);" class="form-control" value="{$adultos}" maxlength="4" class="form-control" placeholder="Adultos *" /> 
                                     </div>
                                    </div> 
                                    <div class="col-xs-4 no_padding">
                                     <div class="input-group">
                                     ...
                                     <label class="sr-only" for="Pax">Cantidad de Niños:</label>
                                         <input class="form-control" name="ninos" type="text" id="ninos" onkeypress="javascript: return validarnum(event);"  value="{$ninos}" maxlength="4" placeholder="Niños" />
                                     </div>
                                    </div>
                                    <div class="col-xs-4 no_padding"> 
                                     <div class="input-group">
                                        ...
                                        <input class="form-control" name="edades" type="text" id="edades" value="{$edades}" maxlength="20" placeholder="Ej 3,6" />
                                     </div>
                                     </div>
                             </div>
                           </div>
                    ...
                    <input name="excursion" type="hidden" id="excursion"  value="{$id}" />
                    ...
                    {/if}
  <a id="btn_reserva" class="btn btn-default btn-block" title="Reserva de {$accion}" href="javascript:document.formulario_reserva.submit();"> <i class="fa fa-calendar-check-o"></i> &nbsp; Enviar</a>
