  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="clear"></div>
                  ...
                  {$mensaje2}
                    ...
                    <tr>
         <td width="50%" align="center" valign="top" class="subtituloWeb3"><form action="" method="post" name="form2" id="form2" onsubmit="MM_validateForm('login','','R');return document.MM_returnValue">
           <table width="100%" align="center" class="tabla_form">
             <tr>
               <td colspan="2" align="center" class="titulo_alt">Si ya posees una cuenta en Betcourvitur.com.ec , accesa aqu&iacute;</td>
              </tr>
             <tr>
               <td width="183" align="left" class="titulo_alt">Login:</td>
               <td width="469" align="left" class="normalContenido"><input value="{$nombre}" name="login" type="text" id="login" size="45" />
               *</td>
              </tr>
             <tr>
               <td align="left" class="titulo_alt">Clave:</td>
               <td align="left" class="normalContenido"><input value="{$apellido}" name="clave" type="password" id="clave" size="45" />
               *</td>
              </tr>
             <tr>
         ...
         <form action="" method="post" name="form1" id="form1" onsubmit="MM_validateForm('cedula','','RisNum','nombre','','R','apellido','','R','correo','','RisEmail','celular','','RisNum');return document.MM_returnValue">
                <table  align="center" class="tabla_form">
                    <tr>
                      <td colspan="2" align="center" class="titulo_alt">Al crear una cuenta en Betcourvitur.com.ec, podr&aacute; realizar solicitudes<br />                        de nuestros productos, via web desde la comodidad de su casa.</td>
                  </tr>
                  {$mensaje3}
                  <tr>
                    ...
                    <td class="normalContenido"><input name="celular" type="text"  id="celular" value="{$celular}" size="40" maxlength="20" onkeypress="javascripts: return validarnum(event);" /> 
                      *</td>
                       ...
                       <tr>
                         ...
                         acepto los <a class="noticia" target="_blank" href="/Templates/contenido.php?cont=19">t&eacute;rminos y condiciones</a> 
                         establecidos por {$nombre_empresa}</td>
                       </tr>
                       <tr>
