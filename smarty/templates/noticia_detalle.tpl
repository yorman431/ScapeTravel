            ...
            <div class="col-xs-12">
                <div class="panel panel default">
                    <div class="panel-body">
                         <h3>{$titulo}</h3>
                         <h4>{$subtitulo}</h4> 
                         <h5><i class="fa fa-user"></i> {$autor} | <i class="fa fa-calendar-o"></i> {$fecha}</h5> 
                     </div>
                      <div class="panel-body">
                            {$contenido}
                      </div>
                      <div class="panel-footer">
                	      <a  class="btn btn-primary btn-block" title="Volver a Noticias" href="noticias.php" role="button" style="background-color:#0073c4; border-color:transparent;"><i class="fa fa-arrow-circle-o-left"></i>&nbsp;Volver a Noticias</a>
                      </div>
                  </div>
              </div>   
  	      </div>
