	...
	<!-- InstanceBeginEditable name="contenido" -->
   		<div class="row">
        	{if $mensaje2 eq ""}
                 ...
                 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 ajuste-margin" style="margin-bottom:15px; {if $cont2 le 4} margin-top:15px; {/if}">
          ...
          {assign var="cont2" value=$cont2+1}
            	<div class="panel panel-default panel-cotizacion">
                	<div class="panel-header" style="background-color:#0073c4; color:#fff;" align="center">
                  		<h4 class="no_margin2" style="padding-bottom:15px; padding-top:15px;">{$galeria[i].nombre_gal}</h4>
                    </div>
                    <div class="panel-body titulo" align="center" style="padding-bottom:0px;">
                    	<p>{$galeria[i].fecha_gal}</p>
                    </div>
                    <div class="panel-body no_padding no_padding2" align="center">
                     	<a title="{$galeria[i].nombre_gal}" href="/galeria_detalle.php?id={$galeria[i].id_gal}">
                                    <img class="opacidad img-responsive" src="/imagenes/{$galeria[i].directorio_image}" alt="{$galeria[i].nombre_image}" />
                        </a>
                    </div>
                    <div class="panel-footer">
                    	<a class="btn btn-default btn-block" title="{$galeria[i].titulo_not}" href="/galeria_detalle.php?id={$galeria[i].id_gal}" role="button">Ver más  &nbsp; <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
          </div> 
