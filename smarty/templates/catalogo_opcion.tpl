	...
	<!-- InstanceBeginEditable name="contenido" -->
     <div class="row">
    	<div class="col-xs-12 no_padding" align="center">
            ...
            {if $num_cat eq '54'}
  				<li><a href="#"><i class="fa fa-ship"></i>&nbsp;Cruceros</a></li>    
            {elseif $num_cat eq '53' }
                <li><a href="#"><i class="fa fa-gift"></i>&nbsp;Promociones</a></li>
            {else}
                <li><a href="#"><i class="fa fa-camera"></i>&nbsp;Excursiones</a></li>
            {/if}
			</ol>
        ...
        {assign var="cont2" value=$cont2+1}          	
                <div class="panel panel-default panel-cotizacion" style="border-right:solid 1px #eee;">
                    <div class="panel-header" style="background-color:#0073c4; color:#fff;">
                    	<h4 align="center" style="height:30px; padding-top:5px;"class="no_margin2">{$listado[i].nombre_pro|truncate:30}</h4>	
                    </div>
                	<div class="panel-body no_padding no_padding2">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no_padding no_padding2"> 
                    	<a title="{$listado[i].nombre_pro}" href="catalogo_detalle.php?id={$listado[i].id_pro}&cat={$cat}">
                	{if $listado[i].directorio_image neq ""}
                            <img class="img-responsive opacidad" alt="{$listado[i].nombre_pro}, hoteles Venezuela, hoteles en Venezuela, paquetes para Venezuela, alojamiento en Venezuela" src="/imagenes/{$listado[i].directorio_image}"/>
                        {else}
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no_padding no_padding2">
                        ...
                        <div class="panel-body no_padding no_padding2">
                    	<ul class="list-group">
                              <li class="list-group-item text-center titulo"><h4 style="margin-bottom:0px;">Desde: Bs. {$listado[i].detal_pro}</h4></li>
                              
                              <li class="list-group-item">{if $listado[i].descripcion_pro neq ""}
                                <p style="margin-bottom:0px;">{$listado[i].descripcion_pro|truncate:100}</p>
                    ...
                    <div class="panel-footer">
                              		<a class="btn btn-default btn-block" title="{$listado[i].nombre_pro}" href="catalogo_detalle.php?id={$listado[i].id_pro}&cat={$cat}">Ver más  &nbsp; <i class="fa fa-arrow-circle-right"></i></a>
                              </div>
                </div>
