<?php /* Smarty version 2.6.9, created on 2017-02-21 16:10:19
         compiled from registro.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'registro.tpl', 399, false),array('modifier', 'lower', 'registro.tpl', 774, false),array('modifier', 'capitalize', 'registro.tpl', 774, false),)), $this); ?>
<!DOCTYPE html>
...
" maxlength="100" placeholder="Nombre *" /> 
                            ...
                            <div class="form-group" style="border-left: 1px solid #ddd;">
                         		<label class="sr-only" for="apellido">Apellido</label>
                        			...
                        			<input onkeypress="javascript: return validarletras(event);" name="apellido" type="text" id="apellido" value="<?php echo $this->_tpl_vars['apellidos']; ?>
" size="40" maxlength="50" class="form-control" placeholder="Apellido *"/>
                          ...
                          <label class="sr-only" for="genero">Genero</label>
                             ...
                             <select name="sexo" id="sexo" class="form-control">
                                  <option value="Masculino" <?php if ($this->_tpl_vars['sexo'] == 'Masculino'): ?> selected='selected' <?php endif; ?>>Masculino</option>
                                  <option value="Femenino" <?php if ($this->_tpl_vars['sexo'] == 'Femenino'): ?> selected='selected' <?php endif; ?>>Femenino</option>
                            </select>
                         ...
                         <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></span>
                        	<input onKeyPress="javascript: return validarcorreo(event);" name="correo" type="text" id="correo" value="<?php echo $this->_tpl_vars['correo']; ?>
" size="40" maxlength="100" class="form-control" placeholder="Correo *" />
                            </div>
                        </div>
                      ...
                      <div class="form-group">
                          ...
                          <span class="input-group-addon"><span class="glyphicon glyphicon-earphone"></span></span>
                        	<input name="celular" type="text"  id="celular" value="<?php echo $this->_tpl_vars['celular']; ?>
" size="40" maxlength="20" onKeyPress="javascripts: return validarnum(event);" class="form-control" placeholder="Celular *" /> 
                          </div>
                        </div>
                 ...
                 <div class="form-group" style="border-left: 1px solid #ddd;">
                    <label class="sr-only" for="donde nos conocio">&iquest;C&oacute;mo nos conoci&oacute;?</label>
                    	...
                    	<select name="medio" id="medio" class="form-control">
                          ...
                          <option <?php if ($this->_tpl_vars['medio'] == 'Twitter'): ?> selected='selected' <?php endif; ?> value="Twitter">Twitter</option>
                          ...
                          <option <?php if ($this->_tpl_vars['medio'] == 'Periodico'): ?> selected='selected' <?php endif; ?> value="Periodico">Peri&oacute;dico</option>
                    ...
                    <div class="form-group">
                      Acepto los <a class="Terminos" target="_blank" href="/contenido.php?cont=19">t&eacute;rminos y condiciones</a> establecidos por <?php echo $this->_tpl_vars['nombre_empresa']; ?>
