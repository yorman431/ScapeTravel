<?php /* Smarty version 2.6.9, created on 2016-12-13 02:41:52
...
<table width="400" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="marco">
  <tr>
    <td align="center" background="/imagenes/fondo_admin.jpg"><img src="/imagenes/logo.jpg" width="400" height="122" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><form action="" method="post" name="form1" id="form1" onsubmit="MM_validateForm('login','','R','password','','R');return document.MM_returnValue">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="normal">
          <tr>
            <td colspan="3" align="center" class="titulo">Autenticaci&oacute;n de Usuario </td>
          </tr>
          ...
          <tr>
            <td align="left" class="tituloWeb">Clave:</td>
          ...
          <tr>
            ...
            <a href="recuperar_clave.php">&nbsp;&nbsp;&iquest;Olvid&oacute; su clave? </a></td>
          </tr>
        </table>
    </form></td>
  </tr>
