<?php /* Smarty version 2.6.9, created on 2016-12-10 21:55:12
         compiled from catalogo_detalle.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'catalogo_detalle.tpl', 583, false),array('modifier', 'lower', 'catalogo_detalle.tpl', 958, false),array('modifier', 'capitalize', 'catalogo_detalle.tpl', 958, false),)), $this); ?>
<!DOCTYPE html>
 ...
 <?php echo $this->_tpl_vars['enlaces_B'][$this->_sections['i']['index']]['nombre_cat']; ?>
    ...
    <div class="container-fluid no_padding">
        ...
        <div class="col-xs-12" align="center">
              <h2 style="margin-bottom:30px; margin-top:30px;"><?php echo $this->_tpl_vars['accion']; ?>
</h2>
        </div>
      </div>
...
<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="padding-bottom:15px;">
    ...
    <div id="galeria_catalogo" class="carousel slide" data-ride="carousel"> 
          <!-- Indicators -->
          <ol class="carousel-indicators">
          <?php $this->assign('cont', 0); ?>
          <?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['opciones_img']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['i']['show'] = true;
$this->_sections['i']['max'] = $this->_sections['i']['loop'];
$this->_sections['i']['step'] = 1;
$this->_sections['i']['start'] = $this->_sections['i']['step'] > 0 ? 0 : $this->_sections['i']['loop']-1;
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
            <li data-target="#galeria_catalogo" data-slide-to="<?php echo $this->_tpl_vars['cont']; ?>
...
?>
            <div <?php if ($this->_tpl_vars['cont'] == '0'): ?>class="item active"<?php else: ?>class="item"<?php endif; ?>>
              <img class="img-responsive" alt="<?php echo $this->_tpl_vars['opciones_img'][$this->_sections['i']['index']]['nombre_image']; ?>
" src="/imagenes/<?php echo $this->_tpl_vars['opciones_img'][$this->_sections['i']['index']]['directorio_image']; ?>
">    
            </div>
          <?php $this->assign('cont', $this->_tpl_vars['cont']+1); ?>
          <?php endfor; endif; ?>
          ...
          <a class="left carousel-control" href="#galeria_catalogo" role="button" data-slide="prev">
            <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
          </a>
          <a class="right carousel-control" href="#galeria_catalogo" role="button" data-slide="next">
...
<!--pestañas-->
       ...
       <?php endif; ?>   
    	<div class="panel panel-default panel-cotizacion" align="center" style="margin-bottom:100px;">
        	<div class="panel-body no_padding no_padding2">
                <ul class="nav nav-tabs" style="background-color:#e6e6e6; border-bottom-color:#8a8a8a;">
                          ...
                          <div id="video" class="tab-pane fade">
                             <div class="panel panel-default paneltabs">
                              <div class="panel-body">
                                    ...
                                    <?php if ($this->_tpl_vars['tipo_video'] == 'Vimeo'): ?>
                                        <?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
...
?>
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="//player.vimeo.com/video/<?php echo $this->_tpl_vars['videos'][$this->_sections['i']['index']]; ?>
"  frameborder = "0" webkitallowfullscreen mozallowfullscreen allowfullscreen> </iframe>
                                   ...
                                   <!--Modelo de video Youtube-->
                                    <?php if ($this->_tpl_vars['tipo_video'] == 'Youtube'): ?>
                                        <?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['videos']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['i']['show'] = true;
...
?>
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/<?php echo $this->_tpl_vars['videos'][$this->_sections['i']['index']]; ?>
" frameborder="0" allowfullscreen></iframe>
                          ...
                          <?php if ($this->_tpl_vars['opciones_img'] != ""): ?>                           
...
?>
                                  ...
                                  <a class="thumbnail" title="<?php echo $this->_tpl_vars['opciones_img'][$this->_sections['i']['index']]['nombre_dir']; ?>
" href="/imagenes/<?php echo $this->_tpl_vars['opciones_img'][$this->_sections['i']['index']]['directorio_image']; ?>
" data-toggle="lightbox" data-title="<?php echo $this->_tpl_vars['opciones_img'][$this->_sections['i']['index']]['nombre_image']; ?>
" data-gallery="multiimages" data-footer="">
                                       <img  src="/imagenes/<?php echo $this->_tpl_vars['opciones_img'][$this->_sections['i']['index']]['directorio_image']; ?>
" alt="<?php echo $this->_tpl_vars['opciones_img'][$this->_sections['i']['index']]['nombre_image']; ?>
" class="img-responsive" width="700" />
                ...
                <!---Termina El panel de promociones--->   
                     ...
                     <div class="panel-footer" id="mostre-todo" style="border: 1px solid #8a8a8a;">
                    <a class="btn btn-default btn-block visible" title="Reservar <?php echo $this->_tpl_vars['accion']; ?>
" href="#visible" onclick="mostrar()"> <i class="fa fa-calendar-check-o"></i> &nbsp; Solicitar Reserva</a>
                     </div>
                   </div>
             </div>
			</div>
            <!--- Formulario Reserva -->
              <div class="row" style="<?php if ($this->_tpl_vars['error'] == 'no'): ?> display:none;<?php endif; ?> height:766px; background-image:url(/imagenes/formularios.jpg); background-repeat:no-repeat; padding-top:20px;"  id="visible">
              <div class="col-xs-12" align="center">
                        <h1 style="color:#fff;">Reserva <?php echo $this->_tpl_vars['accion']; ?>
</h1>
                </div>
                            	...
                            	<div class="row">
                                   ...
                                   <div class="input-group">
                                            ...
                                            <label class="sr-only" for="Pax"># Pax:</label>
                                                <input  name="adultos" type="text" id="adultos" onkeypress="javascript: return validarnum(event);" class="form-control" value="<?php echo $this->_tpl_vars['adultos']; ?>
" maxlength="4" class="form-control" placeholder="Adultos *" /> 
                                    ...
                                    <div class="col-xs-4 no_padding">
                                     ...
                                     <label class="sr-only" for="Pax">Cantidad de Niños:</label>
                                         <input class="form-control" name="ninos" type="text" id="ninos" onkeypress="javascript: return validarnum(event);"  value="<?php echo $this->_tpl_vars['ninos']; ?>
" maxlength="4" placeholder="Niños" />
                                     </div>
                                    </div>
                                    <div class="col-xs-4 no_padding"> 
                                     <div class="input-group">
                                        ...
                                        <input class="form-control" name="edades" type="text" id="edades" value="<?php echo $this->_tpl_vars['edades']; ?>
" maxlength="20" placeholder="Ej 3,6" />
                              ...
                              <span class="input-group-addon"><span class="glyphicon glyphicon-pencil"></span></span>
                               ...
                               <textarea name="comentario" class="form-control" cols="60" rows="6" id="comentario" placeholder="Observaciones"><?php echo $this->_tpl_vars['comentario']; ?>
</textarea>
                               </div>
                              </div>
                    </div>
                    ...
                    <input name="excursion" type="hidden" id="excursion"  value="<?php echo $this->_tpl_vars['id']; ?>
" />
                    <input name="enviar" type="hidden" id="enviar"  value="Enviar Solicitud" />
                    <?php if ($this->_tpl_vars['num_cat'] == '9'): ?> 
                    	<input name="opc_prom" type="hidden"   value="Promociones" />
                    <?php elseif ($this->_tpl_vars['num_cat'] == '4'): ?> 
                    	<input name="opc_exc" type="hidden"   value="Excursiones" />
                    <?php elseif ($this->_tpl_vars['num_cat'] == '5'): ?> 
                    	<input name="opc_cru" type="hidden"   value="Cruceros" />
                    <?php endif; ?>
  <a id="btn_reserva" class="btn btn-default btn-block" title="Reserva de <?php echo $this->_tpl_vars['accion']; ?>
" href="javascript:document.formulario_reserva.submit();"> <i class="fa fa-calendar-check-o"></i> &nbsp; Enviar</a>
