<?php /* Smarty version 2.6.9, created on 2016-12-09 22:35:41
         compiled from admin/traslado/condicion.tpl */ ?>
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="MM_validateForm('nombre','','R');return document.MM_returnValue">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="normal">
    <tr>
      <th width="800" align="center" class="titulo"><img src="/imagenes/cuadros.png" width="14" height="14" align="left" /><?php echo $this->_tpl_vars['accion']; ?>
<img src="/imagenes/cuadritos.png" width="37" height="11" align="right" /></th>
    ...
    <tr>
      <td align="right" class="subtituloWeb3">
        ...
        <tr>
          <td align="right" class="subtituloWeb3">Condiciones:</td>
          <td><textarea rows="6" cols="70" name="condiciones" type="text" class="componentes" id="condiciones" value="<?php echo $this->_tpl_vars['condiciones']; ?>
"><?php echo $this->_tpl_vars['condiciones']; ?>
</textarea></td>
        </tr>
        <tr>
          <td align="center" class="normalContenido" colspan="2">
            <input name="envio" type="submit" class="componentes" id="button" onclick="javascript: return validarcontenido('&iquest;Est&aacute; seguro que desea guardar?');" value="Guardar" />
            &nbsp;
            <input type="button" name="Submit3"  class="normalContenido" value="Cancelar" onclick="javascripts: location.href='/admin/traslado/'" />(*) Datos Obligatorios
          </td>
        </tr>
