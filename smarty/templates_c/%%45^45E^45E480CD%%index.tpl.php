<?php /* Smarty version 2.6.9, created on 2017-03-22 21:38:32
         compiled from index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'index.tpl', 473, false),array('modifier', 'count', 'index.tpl', 533, false),)), $this); ?>
<!DOCTYPE html>
...
" href="#" class="dropdown-toggle botones" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo $this->_tpl_vars['enlaces_A'][$this->_sections['i']['index']]['nombre_cat']; ?>
...
"><?php echo $this->_tpl_vars['enlaces_A'][$this->_sections['i']['index']]['enlaces'][$this->_sections['j']['index']]['nombre_cat']; ?>
                      ...
                      <?php else: ?>
                         <?php if ($this->_tpl_vars['enlaces_A'][$this->_sections['i']['index']]['id_cat'] == '52'): ?>
                            <li <?php if ($this->_tpl_vars['enlaces_A'][$this->_sections['i']['index']]['id_cat'] == $this->_tpl_vars['activo']): ?>class="active"<?php endif; ?>><a class="botones on" title="<?php echo $this->_tpl_vars['enlaces_A'][$this->_sections['i']['index']]['etiqueta_cat']; ?>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
                	<li <?php if ($this->_tpl_vars['enlaces_B'][$this->_sections['i']['index']]['id_cat'] == $this->_tpl_vars['activo']): ?>class="active"<?php endif; ?>><a class="botones on" title="<?php echo $this->_tpl_vars['enlaces_B'][$this->_sections['i']['index']]['etiqueta_cat']; ?>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
                                      				<li data-target="#myCarousel" data-slide-to="<?php echo $this->_tpl_vars['cont']; ?>
...
?>
                                         ...
                                         <img class="img-responsive" alt="<?php echo $this->_tpl_vars['banner'][$this->_sections['i']['index']]['etiqueta_ban']; ?>
" src="/imagenes/banner/<?php echo $this->_tpl_vars['banner'][$this->_sections['i']['index']]['url_ban']; ?>
">
                                    
                                                        <div class="container">
                                                            <div class="carousel-caption">
                                                                <h1><?php echo $this->_tpl_vars['banner'][$this->_sections['i']['index']]['etiqueta_ban']; ?>
</h1>
                                                                <?php echo $this->_tpl_vars['banner'][$this->_sections['i']['index']]['descripcion_ban']; ?>
                        	...
                        	<form  action="resultado.php" method="post" name="form_buscar" id="form_buscar" onsubmit="MM_validateForm('keywords','','R');return document.MM_returnValue">
                            	<div class="form-group">
                                    <div class="input-group">
                                       ...
                                       <input class="form-control" name="keywords" type="text" id="keywords" value="<?php echo $this->_tpl_vars['keywords']; ?>
" maxlength="100" placeholder="Nombre del Hotel" />
              						</div>
                                </div>
                                <div class="form-group">
                                	<div class="input-group">
                                    ...
                                    <label class="sr-only" for="localidad">Localidad:</label>
                                        <select class="form-control" name="localidad" id="localidad">
                                            <option <?php if ($this->_tpl_vars['localidades'][$this->_sections['i']['index']]['ciudad_hot'] == ""): ?> selected='selected'<?php endif; ?> value=""><-- Todas --></option>
                                            <?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['localidades']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['i']['show'] = true;
$this->_sections['i']['max'] = $this->_sections['i']['loop'];
$this->_sections['i']['step'] = 1;
$this->_sections['i']['start'] = $this->_sections['i']['step'] > 0 ? 0 : $this->_sections['i']['loop']-1;
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
                                            <option <?php if ($this->_tpl_vars['localidades'][$this->_sections['i']['index']]['ciudad_hot'] == $this->_tpl_vars['localidad']): ?> selected='selected'<?php endif; ?> value="<?php echo $this->_tpl_vars['localidades'][$this->_sections['i']['index']]['ciudad_hot']; ?>
"><?php echo $this->_tpl_vars['localidades'][$this->_sections['i']['index']]['ciudad_hot']; ?>
</option>
                                            <?php endfor; endif; ?> 
                                        </select>
                                	</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="sr-only" for="categoria">Categoria:</label>
                                     <select class="form-control" name="categoria" id="categoria">
                                            <option <?php if ($this->_tpl_vars['categoria'] == ""): ?> selected='selected'<?php endif; ?> value=""><-- Todas --></option>
                                            ...
                                            <option <?php if ($this->_tpl_vars['categoria'] == '1'): ?> selected='selected'<?php endif; ?> value="1">Posada</option>
                                          </select>
                        ...
                        <div class="panel-footer">
                    		<input name="hotel" type="hidden" id="enviar"  value="<?php echo $this->_tpl_vars['id']; ?>
" /> 
                       ...
                       <div class="form-group">
                        <div class="input-group">
                          ...
                          <select name="tipo" id="tipo">
                              <option value="V-" <?php if ($this->_tpl_vars['tipo'] == "V-"): ?> selected='selected' <?php endif; ?>>V</option>
                              <option value="E-" <?php if ($this->_tpl_vars['tipo'] == "E-"): ?> selected='selected' <?php endif; ?>>E</option>
                              <option value="P-" <?php if ($this->_tpl_vars['tipo'] == "P-"): ?> selected='selected' <?php endif; ?>>P</option>
                              <option value="RIF:" <?php if ($this->_tpl_vars['tipo'] == "RIF:"): ?> selected='selected' <?php endif; ?>>RIF</option>
                          </select> </span>
                          
                          <label class="sr-only" for="identificacion" >Cédula o Pasaporte:</label>
                      <input name="cedula" type="text" id="cedula" value="<?php echo $this->_tpl_vars['cedula']; ?>
...
" maxlength="50" class="form-control" placeholder="Destino *" /> 
                                           ...
                                           <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no_padding espaciado-10">
                                            ...
                                            <div class='input-group date' id='datetimepicker'>
                                                ...
                                                <input type='text' class="form-control" id="fecha_ida" name="fecha_ida" value="<?php echo $this->_tpl_vars['fecha_ida']; ?>
" placeholder="Partida *" />
                                                <span class="input-group-addon">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no_padding">
                    					...
                    					<div class='input-group date' id='datetimepicker2'>
                        					<span class="input-group-addon">
                           					 ...
                           					 <input type='text' class="form-control" id="fecha_vuelta" name="fecha_vuelta" value="<?php echo $this->_tpl_vars['fecha_vuelta']; ?>
" placeholder="Regreso *" />
                        					<span class="input-group-addon">
                                				<span class="glyphicon glyphicon-calendar"></span>
                        					</span>
                                        	...
                                        	<div class="form-group">
                                     		<div class="input-group">
                                     			<span class="input-group-addon">&nbsp;<i class="fa fa-child"></i>  </span>
                                         			...
                                         			<input class="form-control" name="menores" type="text" id="menores" onkeypress="javascript: return validarnum(event);" onblur="javascript: return numero_ninos();" value="<?php echo $this->_tpl_vars['menores']; ?>
" maxlength="4" placeholder="Menores *" />
                                   ...
                                   <div class="form-group"> 
                                     <div class="input-group">
                                        ...
                                        <input class="form-control" name="edades" type="text" id="edades" onkeypress="javascript: return validarnum_coma(event);" value="<?php echo $this->_tpl_vars['edades']; ?>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
        <?php if ($this->_tpl_vars['cont'] == '4'): ?> <?php $this->assign('cont', 1);  endif; ?>
        <?php if ($this->_tpl_vars['hot'] == '6'): ?></div> <div class="row" <?php if ($this->_tpl_vars['hot'] >= '6'): ?> id="visible" style="display:none;"<?php endif; ?>><?php endif; ?>
    	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 ajuste-margin" style="margin-bottom:15px; <?php if ($this->_tpl_vars['cont2'] <= 3): ?> margin-top:15px; <?php endif; ?>">
        <?php $this->assign('hot', $this->_tpl_vars['hot']+1); ?>
        <?php $this->assign('cont', $this->_tpl_vars['cont']+1); ?>  
        <?php $this->assign('cont2', $this->_tpl_vars['cont2']+1); ?>          	
                <div class="panel panel-default panel-cotizacion">
                    <div class="panel-header" style="background-color:#0073c4; color:#fff;">
                    	<h4 align="center" style="height:30px; padding-top:5px;"class="no_margin2"><?php echo ((is_array($_tmp=$this->_tpl_vars['listado'][$this->_sections['i']['index']]['nombre_hot'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 30) : smarty_modifier_truncate($_tmp, 30)); ?>
</h4>	
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-7 no_padding no_padding2" align="center"> 
                    	<a title="<?php echo $this->_tpl_vars['listado'][$this->_sections['i']['index']]['nombre_hot']; ?>
" href="hotel_detalle.php?id=<?php echo $this->_tpl_vars['listado'][$this->_sections['i']['index']]['id_hot']; ?>
">
                	<?php if ($this->_tpl_vars['listado'][$this->_sections['i']['index']]['directorio_image'] != ""): ?>
                            <img class="img-responsive opacidad" alt="<?php echo $this->_tpl_vars['listado'][$this->_sections['i']['index']]['nombre_hot']; ?>
, hoteles Venezuela, hoteles en Venezuela, paquetes para Venezuela, alojamiento en Venezuela" src="/imagenes/<?php echo $this->_tpl_vars['listado'][$this->_sections['i']['index']]['directorio_image']; ?>
"/>
                        <?php else: ?>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5 no_padding no_padding2">
                    	...
                    	<ul class="list-group">
                              <li class="list-group-item text-center titulo"><h4>Desde Bs. <?php echo $this->_tpl_vars['listado'][$this->_sections['i']['index']]['precio_hot']; ?>
</h4></li>
...
?> 
                              ...
                              <li class="list-group-item"><?php if ($this->_tpl_vars['listado'][$this->_sections['i']['index']]['facilidades'] != ""): ?>
                            <div class="row center-block">
                                <?php unset($this->_sections['j']);
$this->_sections['j']['name'] = 'j';
$this->_sections['j']['loop'] = is_array($_loop=$this->_tpl_vars['listado'][$this->_sections['i']['index']]['facilidades']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['j']['show'] = true;
$this->_sections['j']['max'] = $this->_sections['j']['loop'];
$this->_sections['j']['step'] = 1;
$this->_sections['j']['start'] = $this->_sections['j']['step'] > 0 ? 0 : $this->_sections['j']['loop']-1;
...
$this->_sections['j']['last']       = ($this->_sections['j']['iteration'] == $this->_sections['j']['total']);
?>
                  					   <?php if ($this->_tpl_vars['listado'][$this->_sections['i']['index']]['facilidades'] != ""): ?>
                                         <i class="fa <?php echo $this->_tpl_vars['listado'][$this->_sections['i']['index']]['facilidades'][$this->_sections['j']['index']]['etiqueta_fac']; ?>
 color-fa"></i>
                                       <?php endif; ?>
                    ...
                    <div class="panel-footer">
                              		<a class="btn btn-default btn-block" title="<?php echo $this->_tpl_vars['listado'][$this->_sections['i']['index']]['nombre_hot']; ?>
" href="hotel_detalle.php?id=<?php echo $this->_tpl_vars['listado'][$this->_sections['i']['index']]['id_hot']; ?>
&nombre=<?php echo $this->_tpl_vars['listado'][$this->_sections['i']['index']]['nombre_hot']; ?>
">Ver más  &nbsp; <i class="fa fa-arrow-circle-right"></i></a>
    ...
    <?php if (count($this->_tpl_vars['listado']) > 6): ?>
            	 ...
            	 <?php $this->assign('cont', $this->_tpl_vars['cont']+1); ?>
            	    <div class="panel panel-default panel-cotizacion">
                	  <div class="panel-header" style="background-color:#0073c4; color:#fff;" align="center">
                  		<h4 class="no_margin2" style="padding-bottom:15px; padding-top:15px;">   <?php echo ((is_array($_tmp=$this->_tpl_vars['paquetes'][$this->_sections['i']['index']]['nombre_pro'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 20) : smarty_modifier_truncate($_tmp, 20)); ?>
...
?>
            	...
            	<div class="panel panel-default panel-cotizacion">
                	<div class="panel-header" style="background-color:#0073c4; color:#fff;" align="center">
                    	<h4 class="no_margin2" style="padding-bottom:15px; padding-top:15px;">				<?php echo ((is_array($_tmp=$this->_tpl_vars['excursiones'][$this->_sections['i']['index']]['nombre_pro'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 20) : smarty_modifier_truncate($_tmp, 20)); ?>
</h4>
                    </div>
                    <div class="panel-body titulo" align="center">
...
<br>
                                <p class="fuente-categoria" style="font-size: 12px;"><?php echo $this->_tpl_vars['enlaces_A2'][$this->_sections['i']['index']]['nombre_cat']; ?>
</p>
      					  	</a>
                            <?php endif; ?>
...
<br>
                                <p class="fuente-categoria" style="font-size: 12px;"><?php echo $this->_tpl_vars['enlaces_B2'][$this->_sections['i']['index']]['nombre_cat']; ?>
</p>
                          </a>
                          </div>
                        <?php endfor; endif; ?>
...
$this->_sections['j']['last']       = ($this->_sections['j']['iteration'] == $this->_sections['j']['total']);
?>
                            <li style="padding-top:7px;"><a class="foot-btn" title="<?php echo $this->_tpl_vars['enlaces_C'][$this->_sections['j']['index']]['etiqueta_cat']; ?>
...
"><?php echo $this->_tpl_vars['enlaces_B'][$this->_sections['j']['index']]['nombre_cat']; ?>
</a>
                            </li>
                            <?php endfor; endif; ?>
