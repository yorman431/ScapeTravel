<?php /* Smarty version 2.6.9, created on 2017-02-21 12:51:42
         compiled from contacto.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'contacto.tpl', 361, false),array('modifier', 'lower', 'contacto.tpl', 736, false),array('modifier', 'capitalize', 'contacto.tpl', 736, false),)), $this); ?>
<!DOCTYPE html>
        	...
        	<div class="panel panel-cotizacion">
                ...
                <div class="panel-body">
                     <form action="" method="post" role="form" name="formulario_reserva" id="formulario_reserva" onsubmit="MM_validateForm('email','','RisEmail');return document.MM_returnValue">
                      ...
                      <input  onkeypress="javascrip: return validarletrasnum(event);" type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre Completo" value="<?php echo $this->_tpl_vars['nombre']; ?>
">
          ...
          <input  onkeypress="javascrip: return validarnum(event);" type="number" class="form-control" name="telefono" id="telefono" placeholder="Teléfono" value="<?php echo $this->_tpl_vars['telefono']; ?>
"> 
                          	</div>
                        </div>
                    ...
                    <input  onkeypress="javascrip: return validarcorreo(event);" type="email" class="form-control" id="email" name="email" placeholder="correo@dominio.com" value="<?php echo $this->_tpl_vars['email']; ?>
">
                            </div>
                        </div>
