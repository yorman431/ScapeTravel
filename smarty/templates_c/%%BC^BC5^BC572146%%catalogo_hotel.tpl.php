            	...
            	<form  action="" method="post" name="form_ordenar" id="form_ordenar" class="form-inline"> 
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <select class="form-control" id="orden" name="orden" onchange="javascripts: document.form_ordenar.submit();">
                                <option <?php if ($this->_tpl_vars['ordenar'] == ""): ?> selected='selected'<?php endif; ?> value=""><-- Seleccione --></option>
                                <option <?php if ($this->_tpl_vars['ordenar'] == 'vistas_hot DESC'): ?> selected='selected'<?php endif; ?> value="vistas_hot DESC">M&aacute;s elegidos</option>
                                <option <?php if ($this->_tpl_vars['ordenar'] == 'categoria_hot DESC'): ?> selected='selected'<?php endif; ?> value="categoria_hot DESC">Estrellas: Mayor a menor </option>
                                <option <?php if ($this->_tpl_vars['ordenar'] == 'categoria_hot ASC'): ?> selected='selected'<?php endif; ?> value="categoria_hot ASC">Estrellas: Menor a mayor </option>
                                <option <?php if ($this->_tpl_vars['ordenar'] == "categoria_hot DESC, nombre_hot"): ?> selected='selected'<?php endif; ?> value="categoria_hot DESC, nombre_hot">Precio: Mayor a menor</option>
                                <option <?php if ($this->_tpl_vars['ordenar'] == "categoria_hot ASC, nombre_hot"): ?> selected='selected'<?php endif; ?> value="categoria_hot ASC, nombre_hot">Precio: Menor a mayor</option>
                            </select>
                        </div>
...
?>
    	...
    	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" style="margin-bottom:15px; <?php if ($this->_tpl_vars['cont2'] <= 3): ?> margin-top:15px; <?php endif; ?>">
...
"/>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no_padding no_padding2">
                    	...
                    	<ul class="list-group">
                              <li class="list-group-item text-center titulo"><h4 style="margin-bottom:0px; margin-top:0px;">Desde Bs. <?php echo $this->_tpl_vars['listado'][$this->_sections['i']['index']]['precio_hot']; ?>
</h4></li>
...
?> 
                              ...
                              <li class="list-group-item center-block"><?php if ($this->_tpl_vars['listado'][$this->_sections['i']['index']]['facilidades'] != ""): ?>
                            <div class="row">
                                <?php unset($this->_sections['j']);
$this->_sections['j']['name'] = 'j';
