<?php /* Smarty version 2.6.9, created on 2016-12-10 21:52:00
         compiled from boletos.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'boletos.tpl', 468, false),array('modifier', 'lower', 'boletos.tpl', 843, false),array('modifier', 'capitalize', 'boletos.tpl', 843, false),)), $this); ?>
<!DOCTYPE html>
  ...
  <div class="row">
      <div class="col-xs-12 no_padding" align="center">
          <ol class="breadcrumb no_margin2">
              <li><a href="#"><span class="glyphicon glyphicon-road"></span>&nbsp;&nbsp;Boletos</a></li>
          </ol>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
                    <h3><?php echo $this->_tpl_vars['contenido'][$this->_sections['i']['index']]['nombre_con']; ?>
</h3>
                        <?php echo $this->_tpl_vars['contenido'][$this->_sections['i']['index']]['contenido_con']; ?>
...
" maxlength="100" class="form-control" placeholder="Origen *" /> 
                                     </div>
                                </div>
...
" maxlength="100" class="form-control" placeholder="Destino *" /> 
                                </div>
                          </div> 
                                <div class="form-group">
